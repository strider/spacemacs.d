...
(spacemacs/set-leader-keys "os" 'ivy-yasnippet)
(spacemacs/set-leader-keys "om" 'man)
(spacemacs/set-leader-keys "of" 'counsel-describe-function)
(spacemacs/set-leader-keys "ov" 'counsel-describe-variable)
(spacemacs/set-leader-keys "ol" 'counsel-find-library)
