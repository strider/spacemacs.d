...
(define-abbrev-table 'global-abbrev-table
  '(
    ("Gaël chamoulaud <gchamoul@redhat.com>" "gcha" nil 0)
    ("https://github.com" "gh/" nil 0)
    ("https://github.com/strider/" "ghs/" nil 0)
    ("https://www.redhat.com/" "rhc/" nil 0)
    ("linux" "linux" nil 0)
    ("openstack" "openstack" nil 0)
    ("rdo" "rdo" nil 0)
    ("todo" "todo" nil 0)
    ("tripleo" "tripleo" nil 0)
    ("tripleo-validations" "tv" nil 0)
   ))
